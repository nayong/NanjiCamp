 ...
 */
public class FragmentPrepare3 extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup parentViewGroup, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_prepare_3, parentViewGroup, false);
       ...
       /*ViewPager*/
        mViewPager = (ViewPager) rootView.findViewById(R.id.view_prepare_3);
        indicator = (LinearLayout) rootView.findViewById(R.id.indicator_prepare_3);

        //getSupportFragmentManager -> getChildFragmentManager
        mAdapter = new CustomPagerAdapterPrepare(this.getActivity(), this.getChildFragmentManager(), Manager.FRAGMENT_PREPARE_3);
